...
namespace ResourceWrapper.Generator {
	internal struct ResourceParser {
		...
		public bool Generate(string file, string code, string nameSpace, string className, string resourceName) {
			CultureInfo culture = CultureInfo.InvariantCulture;
			Message.Write("Generating", code);
			StringBuilder text = new StringBuilder();
			text.Append(this.Header());
			text.AppendFormat(culture, TextMessage.ClassHeader, nameSpace, className, resourceName);
